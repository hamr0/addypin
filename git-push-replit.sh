...
echo -e "   ${YELLOW}• AddyPin Staging Deploy${NC} - For testing (port 8080)"
echo -e "   ${YELLOW}• AddyPin Manual Deploy${NC} - For production (port 3000)"
echo ""
echo -e "${CYAN}4. Click 'Run workflow' button${NC}"
echo -e "${CYAN}5. Select 'main' branch and click 'Run workflow'${NC}"
echo ""

echo -e "${BLUE}═══════════════════════════════════════${NC}"
echo -e "${BLUE}📍 Deployment URLs:${NC}"
echo -e "${BLUE}═══════════════════════════════════════${NC}"
echo -e "${CYAN}Staging:${NC} ${YELLOW}http://addypin.com:8080${NC}"
echo -e "${CYAN}Production:${NC} ${YELLOW}http://addypin.com${NC}"
echo ""
